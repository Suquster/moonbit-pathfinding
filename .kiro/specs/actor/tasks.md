...
- [x] 15. 向后兼容回归保障（R14）
  - [x] 15.1 重新生成并核对 `pkg.generated.mbti` 快照
...
- [x] 16. 可执行文档扩充（README.mbt.md，R11.6 R15.3）
  - [x] 16.1 在 `README.mbt.md` 追加可执行示例块
...
- [x] 17. 性能基准与回归 guard（benches/actor_bench/，R12）
  - [x] 17.1 新增 `benches/actor_bench/` 基准包
