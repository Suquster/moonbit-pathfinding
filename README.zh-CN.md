...
| 31 | 🔥 Contraction Hierarchies | `src/advanced/ch.mbt` | 🧪 experimental | Geisberger 2008 |
| 32 | 🔥 Jump Point Search | `src/advanced/jps.mbt` | 🧪 experimental | Harabor & Grastien 2011 |
| 33 | 🔥 ALT (A\* + Landmarks) | `src/advanced/alt.mbt` | 🧪 experimental | Goldberg & Harrelson 2005 |
