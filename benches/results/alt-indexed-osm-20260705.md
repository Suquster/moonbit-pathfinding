...
| 数据集 | 节点/边 | k | 双向 Dijkstra 每查询 | ALT 双向 A* 每查询 | 中位加速比 | 预处理 |
|---|---|---|---|---|---|---|
| 厦门驾车网 | 23925 / 54151 | 8 | 619.8 µs | 600.6 µs | **1.03×** | 19.6 ms |
| 北京驾车网 | 163501 / 406591 | 16 | 6354.8 µs | 1089.0 µs | **5.84×** | 562.0 ms |

代价全量对拍一致（48 查询 × 2 数据集）。路网越大、度量结构越明显，
地标下界越紧，收益越大；预处理成本在 ~50+ 查询即摊薄（北京：562 ms ÷
(6354.8−1089.0) µs ≈ 107 查询回本）。
