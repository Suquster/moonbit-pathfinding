...
- Median of per-case median speedups (MoonBit over Rust): **2.20×**
...
|---|---:|---:|---:|---:|---:|:--:|
| BFS | 1000 | 4 | 1.608 | 0.599 | **2.69×** | ✅ |
| Dijkstra | 1000 | 4 | 5.285 | 2.592 | **2.04×** | ✅ |
| A* | 1000 | 4 | 6.579 | 5.332 | **1.23×** | ✅ |
| BFS | 1000 | 16 | 1.502 | 0.495 | **3.04×** | ✅ |
| Dijkstra | 1000 | 16 | 10.749 | 5.255 | **2.05×** | ✅ |
| A* | 1000 | 16 | 12.618 | 9.305 | **1.36×** | ✅ |
| BFS | 10000 | 4 | 17.515 | 7.454 | **2.35×** | ✅ |
| Dijkstra | 10000 | 4 | 55.104 | 21.688 | **2.54×** | ✅ |
| A* | 10000 | 4 | 75.213 | 63.701 | **1.18×** | ✅ |
| BFS | 10000 | 16 | 10.414 | 3.977 | **2.62×** | ✅ |
| Dijkstra | 10000 | 16 | 136.924 | 52.499 | **2.61×** | ✅ |
| A* | 10000 | 16 | 159.338 | 110.963 | **1.44×** | ✅ |
