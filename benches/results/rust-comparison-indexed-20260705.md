...
| Dijkstra | 10000 | 16 | 136.924 | 51.963 | **2.64×** | ✅ |
| A* | 10000 | 16 | 159.338 | 57.935 | **2.75×** | ✅ |

- **Median of per-case median speedups: 2.45×（此前 0.2498×）**——12/12
  用例全部快于 Rust：BFS 2.3-3.0×、Dijkstra 2.0-2.6×、A* 2.0-2.8×。
